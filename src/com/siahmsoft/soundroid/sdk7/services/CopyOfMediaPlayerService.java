...
public class CopyOfMediaPlayerService extends Service {
    ...
    public class MediaPlayerBinder extends Binder {
        public CopyOfMediaPlayerService getService() {
            return CopyOfMediaPlayerService.this;
        }
    }
    ...
    private class TelephoneCallStateListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            if (state == TelephonyManager.CALL_STATE_IDLE && musicInterruptedByCall	&& !mMediaPlayer.isPlaying()) {
    ...
    public void playSong(TracksStore.Track track) throws IllegalArgumentException, IllegalStateException, IOException{
        ...
        if(track == null){
            ...
            if("private".equals(track.getmSharing())){
                url = Soundroid.getSc().sign(url);
            }
            ...
            if(soundcloudTrack == null){
                ...
                if(soundcloudTrack.getmIdTrack() == track.getmIdTrack()){
                    ...
                    //reproduce nuevo tema
                    if(mMediaPlayer.isPlaying()){
                        stopSong();
                        playSong(track);
                        soundcloudTrack = track;
                    }else{
                        if(!(soundcloudTrack.getmIdTrack() == track.getmIdTrack()) && !isPaused){
    ...
    public void stopSong() throws IllegalArgumentException, IllegalStateException, IOException{
        if(mMediaPlayer.isPlaying()){
            mMediaPlayer.stop();
            mMediaPlayer.reset();
            soundcloudTrack = null;
    ...
    private void showNotification(String text) {
        ...
        Notification notification = new Notification(android.R.drawable.ic_media_play, text, System.currentTimeMillis());
        ...
        notification.setLatestEventInfo(this, getText(android.R.string.ok), text, contentIntent);
